...
| **S4** Prefest A/B | 6–7 | ≥50–100 агентов, 2 варианта на **своём** артефакте | Отчёт + раздел валидности |
...
Кураторский список ссылок: [`external-materials.md`](./external-materials.md) (офлайн-снапшоты PDF в публичный репозиторий не входят).
